...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const renderRecentProduct = () => {
        ...
        recentProductNotice.innerHTML = `<div class="recent-product-inner"><span>${escapeHtml(siteText.products.recentlyViewed)}:</span><strong>${escapeHtml(recent.name)}</strong></div>`;
    };
